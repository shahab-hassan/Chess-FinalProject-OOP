...
//        Piece whiteLeftNeighbor=Game.blocks[block.getRow()][block.getCol()-1].getPiece();
//        Piece whiteRightNeighbor=Game.blocks[block.getRow()][block.getCol()+1].getPiece();
//        Piece blackLeftNeighbor=Game.blocks[block.getRow()][block.getCol()+1].getPiece();
//        Piece blackRightNeighbor=Game.blocks[block.getRow()][block.getCol()-1].getPiece();
...
//        else
//            Game.blocks[selectedRow][selectedCol].getPiece().enPassantRequirement=false;
...
//                        Game.blocks[selectedRow+1][selectedCol+1].getLabel().setBorder(Utilities.applyBorder(MyColors.dangerPieceBorderDefault, 3));
//                    }
...
//                if(Game.blocks[selectedRow][selectedCol].getPiece().isBlack){
//                    if(Game.blocks[selectedRow+1][selectedCol-1].getPiece()==null){
//                        Game.blocks[selectedRow+1][selectedCol-1].getPane().setBorder(Utilities.applyBorder(MyColors.dangerPieceBorderDefault, 3));
//                    }
//                }else if(!Game.blocks[selectedRow][selectedCol].getPiece().isBlack){
//                    if(Game.blocks[selectedRow-1][selectedCol+1].getPiece()==null){
//                        Game.blocks[selectedRow-1][selectedCol+1].getPane().setBorder(Utilities.applyBorder(MyColors.dangerPieceBorderDefault, 3));
